...
table.insert(mykeys, { key="b", mods="LEADER", action=wezterm.action{SplitVertical={domain="CurrentPaneDomain"}}} )
table.insert(mykeys, { key="n", mods="LEADER", action=wezterm.action{SplitHorizontal={domain="CurrentPaneDomain"}}} )
...
-- Pane sizes
table.insert(mykeys, { key = "H", mods = "LEADER|SHIFT", action=wezterm.action{AdjustPaneSize={"Left", 5}}})
